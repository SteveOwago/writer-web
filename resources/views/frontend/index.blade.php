...
@section('content')
    <section class="hero-wrap"
        style="background-image:url({{ asset('frontend/images/xbg_1.jpg.pagespeed.ic.LEZ7WXICMQ.jpg') }})">
        ...
        <div class="container-xl">
            <div class="row g-xl-5">
                <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100"
                    ...
                    <div class="img w-100"
                        style="background-image:url({{ asset('frontend/images/xabout.jpg.pagespeed.ic.-KcLZunmgU.jpg') }})">
                    </div>
                </div>
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="text">
                                        ...
                                        <div class="author-wrap d-flex align-items-center">
                                            <div class="img"
                                                style="background-image:url(images/xauthor-1.jpg.pagespeed.ic.gWpEzQ4x3B.jpg)">
                                            </div>
                            ...
                            <div class="courses">
                                <div class="d-flex">
                                    ...
                                    <div class="text">
                                        ...
                                        <div class="author-wrap d-flex align-items-center">
                                            <div class="img"
                                                style="background-image:url({{ asset('frontend/images/xauthor-1.jpg.pagespeed.ic.gWpEzQ4x3B.jpg') }})">
                                            </div>
                                            <span class="author">by John Smith</span>
                                        </div>
                                        <p class="lec"><a href="#">50 lectures (190 hrs)</a></p>
                            ...
                            <div class="testimony-wrap">
                                <div class="text">
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="user-img"
                                            style="background-image:url({{ asset('frontend/images/xperson_1.jpg.pagespeed.ic.P4pHl6glbj.jpg') }})">
                        ...
                        <div class="item">
                            <div class="testimony-wrap">
                                <div class="text">
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="user-img"
                                            style="background-image:url({{ asset('frontend/images/xperson_2.jpg.pagespeed.ic.yyrmjBH91b.jpg') }})">
                                            <div class="icon d-flex align-items-center justify-content-center"><span
                                                    class="fa fa-quote-left"></div>
                                        </div>
                                        <div class="ps-3 tx">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 d-flex">
                    <div class="blog-entry justify-content-end" data-aos="fade-up" data-aos-duration="1000"
                        ...
                        <a href="blog-single.html" class="block-20 img"
                            style="background-image:url({{ asset('frontend/images/ximage_1.jpg.pagespeed.ic.UgmmPhXrdT.jpg') }})">
                        </a>
                        <div class="text">
                ...
                <div class="col-md-6 col-lg-4 d-flex">
                    <div class="blog-entry justify-content-end" data-aos="fade-up" data-aos-duration="1000"
                        data-aos-delay="100">
                        <a href="blog-single.html" class="block-20 img"
                            style="background-image:url({{ asset('frontend/images/ximage_2.jpg.pagespeed.ic.VzEAApnz9L.jpg') }})">
                        </a>
                        <div class="text">
                            <p class="meta"><span><i class="fa fa-user me-1"></i>Admin</span> <span><i
                                        class="fa fa-calendar me-1"></i>Jan. 18, 2021</span> <span><a href="#"><i
                    ...
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <div class="block-21 mb-4 d-flex">
                            <a class="blog-img img rounded"
                                style="background-image:url({{ asset('frontend/images/ximage_1.jpg.pagespeed.ic.UgmmPhXrdT.jpg') }})"></a>
                            <div class="text">
                                <div class="meta">
                        ...
                        <div class="block-21 mb-4 d-flex">
                            <a class="blog-img img rounded"
                                style="background-image:url({{ asset('frontend/images/ximage_2.jpg.pagespeed.ic.VzEAApnz9L.jpg') }})"></a>
                            <div class="text">
                                <div class="meta">
                                    <div><a href="#"><span class="fa fa-calendar"></span> Jan. 18, 2021</a></div>
                                    <div><a href="#"><span class="fa fa-user"></span> Admin</a></div>
                        ...
                        <div class="block-21 mb-4 d-flex">
                            <a class="blog-img img rounded"
                                style="background-image:url({{ asset('frontend/images/ximage_4.jpg.pagespeed.ic.QcOUqWK7Iz.jpg') }})"></a>
                            <div class="text">
                                <div class="meta">
                                    <div><a href="#"><span class="fa fa-calendar"></span> Jan. 18, 2021</a></div>
                                    <div><a href="#"><span class="fa fa-user"></span> Admin</a></div>
                            ...
                            <ul>
                                ...
                                <li><a href="#"><span class="icon fa fa-paper-plane"></span><span
                                            class="text"><span class="__cf_email__"
                                                data-cfemail="2a43444c456a53455f584e45474b434404494547">[email&#160;protected]</span></span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container-xl">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <p class="mb-0" style="font-size: 14px;">Copyright &copy;<script data-cfasync="false" src="cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script>___scripts_1___
